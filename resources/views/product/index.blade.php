                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Namabarang</th><th>Harga</th><th>Stok</th><th>Keterangan</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($product as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->namabarang }}</td><td>{{ $item->harga }}</td><td>{{ $item->stok }}</td><td>{{ $item->keterangan }}</td>
                                        <td>
